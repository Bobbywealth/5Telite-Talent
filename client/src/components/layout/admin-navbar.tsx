...
import { Users, Calendar, ClipboardList, FileText, Search, Menu, ChevronDown, Settings, BarChart3, Home, LayoutDashboard, Shield, Megaphone, BookOpen } from "lucide-react";
...
export default function AdminNavbar() {
  ...
  const navigationItems = [
    ...
    { href: "/admin/booking-requests", label: "Booking Requests", icon: Calendar },
    ...
    { href: "/admin/training", label: "Training Guide", icon: BookOpen },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link href="/" className="flex items-center" data-testid="link-logo-admin">
              <img 
                src={logoImage} 
                alt="5T Talent Platform" 
